...
/**
 * JWT settings, bound from {@code maoyan.jwt.*}.
 *
 ...
 *
 * <p>Override it per environment: {@code MAOYAN_JWT_SECRET}. The default here
...
public class JwtProperties {
     ...
     */
    private String secret = "maoyan-ticket-local-dev-secret-key-change-me-in-production-2026";
    ...
    private String issuer = "maoyan-ticket";
