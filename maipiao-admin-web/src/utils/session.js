...
/**
 * The signed-in user, under the name the admin shell asks for it by.
 *
 * An alias rather than a rename: the customer app imports getStoredUser, and
 * the two frontends share this file's behaviour deliberately - one session
 * shape, one place that knows how it is stored.
 */
