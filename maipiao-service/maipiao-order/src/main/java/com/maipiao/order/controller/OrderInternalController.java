...
/**
 * Service-to-service endpoints for the payment flow (G2, G3). Not publicly
 * routed - the gateway only forwards {@code /api/**} and these live under
 * {@code /inner}.
 *
...
public class OrderInternalController {
    ...
    public R<Void> markPaid(@PathVariable String orderNo,
        ...
        boolean moved = stateMachine.markPaid(orderNo, payTime, "PAY_CALLBACK");
        if (!moved) {
